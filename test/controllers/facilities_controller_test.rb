...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post facilities_url, params: { facility: { location: @facility.location, name: @facility.name, stripe_subscription_id: @facility.stripe_subscription_id, user_id: @facility.user_id } }
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { location: @facility.location, name: @facility.name, stripe_subscription_id: @facility.stripe_subscription_id, user_id: @facility.user_id } }
